...
public final class JDBCUtils {
    ...
    public static void load(String file) {
        config(loadProp(file));
    }

    static {
        //config(loadProp("/application.properties"));
    }

    public static Properties loadProp(String file) {
        try {
            Properties props = new Properties();
            InputStream inputStream = PropertiesUtil.class.getResourceAsStream(file);
    ...
    private static void config(Properties properties) {
         ...
         * 获取URL
         */
        //URL = "jdbc:mysql://172.25.62.81:3306/plateno_bundle??useUnicode=true&characterEncoding=UTF-8";
        /*
         * 获取用户名
         */
        //username = "root";
